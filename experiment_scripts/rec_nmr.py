...
p.add_argument('--epochs_til_ckpt', type=int, default=300)
p.add_argument('--steps_til_summary', type=int, default=300)
p.add_argument('--iters_til_ckpt', type=int, default=600)
...
def multigpu_train(gpu, opt, cache):
    ...
    training.multiscale_training(model=model, dataloader_callback=create_dataloader_callback,
                                 dataloader_iters=(1000000, ), dataloader_params=((64, 10, None), ),
